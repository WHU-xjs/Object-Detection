...
def resnet_base(img_batch, scope_name, is_training=True):
    ...
    with tf.variable_scope('build_pyramid'):
        with slim.arg_scope([slim.conv2d], weights_regularizer=slim.l2_regularizer(cfgs.WEIGHT_DECAY),
            ...
            feature_dict['C4'] = slim.conv2d(feature_dict['C4'],
                                             num_outputs=256,
                                             kernel_size=[1,1],
                                             stride=1,scope='build_C4_1x1')
            
            feature_dict['C3'] = slim.conv2d(feature_dict['C3'],
                                             num_outputs=256,
                                             kernel_size=[1,1],
                                             stride=1,scope='build_C3_1X1')
            ...
            pyramid_dict['P4'] = fusion_two_layer(pyramid_dict['P3'],pyramid_dict['P4'],scope='build_P4_zsh')
            
            pyramid_dict['P4'] = slim.conv2d(pyramid_dict['P4'],
                                             num_outputs=256,kernel_size=[3,3],padding="SAME",
                                             stride=2, scope='build_P4_zsh2')

            pyramid_dict['P5'] = fusion_two_layer(pyramid_dict['P4'],pyramid_dict['P5'],scope='build_P5_zsh')

            pyramid_dict['P5'] = slim.conv2d(pyramid_dict['P5'],
                                             num_outputs=256,kernel_size=[3,3],padding="SAME",
                                             stride=2, scope='build_P5_zsh2')
                                             
            pyramid_dict['P6'] = fusion_two_layer(pyramid_dict['P5'],pyramid_dict['P6'],scope='build_P6_zsh')

            pyramid_dict['P6'] = slim.conv2d(pyramid_dict['P6'],
                                             num_outputs=256,kernel_size=[3,3],padding="SAME",
                                             stride=2, scope='build_P6_zsh2')
            
            pyramid_dict['P7'] = fusion_two_layer(pyramid_dict['P6'],pyramid_dict['P7'],scope='build_P7_zsh')

            pyramid_dict['P7'] = slim.conv2d(pyramid_dict['P7'],
                                             num_outputs=256,kernel_size=[3,3],padding="SAME",
                                             stride=2, scope='build_P7_zsh2')
